...
def save_iter(name, corr_data, tof_data, groupsize=1000, maxlen=None):
...
if __name__ == '__main__':
    ...
    correlated_data = correlate_tof_iter(enumerated_data, etof_data)

    save_iter(output_name, correlated_data, itof_data, groupsize=args.groupsize, maxlen=args.maxlen)

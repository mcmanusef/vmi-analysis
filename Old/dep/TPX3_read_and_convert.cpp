            ...
            if (HeaderBuffer[0] == 'T' && HeaderBuffer[1] == 'P' && HeaderBuffer[2] == 'X') {
                ...
                for (int j = 0; j < size / 8; j++) {
                    ...
                    case 0x6:      //TDC timestamp packet header
						...
						if ((temp >> 56) == 0x6f) tdc_type=0; //cout << "tdc1 rising edge is working" << endl; 
						if ((temp >> 56) == 0x6a) tdc_type=1; //cout << "tdc1 falling edge is working" << endl;
						if ((temp >> 56) == 0x6e) tdc_type=2; //cout << "tdc2 rising edge is working" << endl;
						if ((temp >> 56) == 0x6b) tdc_type=3; //cout << "tdc2 falling edge is working" << endl;					   
                    ...
                    case 0x4:		//the global timestamps.
                        ...
                        else if (((temp >> 56) & 0xF) == 0x5)
                        {
                         ...
                         xy_file << "2  " << setprecision(15) << timemaster * 25e-9 << endl;  //global timestamps can be saved into text file
                        }

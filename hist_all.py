...
for d in os.listdir(source):
    if d[-3:] == '.h5':
        print(d[:-5])
        if d[:-5]+'.mat' not in os.listdir(source) or d == "xe014_e_c.h5":
            p = loadmat("J:\\ctgroup\\DATA\\UCONN\\VMI\\VMI\\20220613\\Ellipticity measurements\\" + d[:-5]+"_power.mat")[d[:-5]+"_power"][0]
            ...
            out = subprocess.run([sys.executable, "C:/Users/mcman/Documents/VMI/get_hist.py",

...
out = signal.convolve(data["full_hist"], gauss3d(1))[3:-3, 3:-3, 3:-3]
...
mlab.view(azimuth=70, elevation=70, focalpoint=c, distance=3)
plt.imsave('p_pol_a.png', mlab.screenshot(mode='rgba'))
plt.imsave('p_pol.png', mlab.screenshot(mode='rgb'))
